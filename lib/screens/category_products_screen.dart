...
//   // Helper method to convert product data to Product model
...
//       deliveryFee: (product['deliveryFee'] ?? 0).toDouble(),
//       images: product['images'] != null ? List<String>.from(product['images']) : [product['imageUrl'] ?? product['image'] ?? ''],
//       unit: product['unit'] ?? '1 piece',
//       vendorId: product['vendorId'] ?? '',
//     );
//   }

//   Widget _buildProductCardWithProvider(BuildContext context, dynamic product, dynamic store, ThemeData theme, EnhancedCartProvider cartProvider) {
//     final productModel = _convertToProduct(product);
//     final storeModel = Store.fromJson(store);
    
//     final int quantity = cartProvider.getItemQuantity(productModel, CartItemSource.store, sourceId: storeModel.id);
...
//                               onTap: () {
//                                 try {
//                                   cartProvider.addFromStore(productModel, storeModel);
...
//                                     onTap: () {
//                                       if (quantity > 1) {
//                                         cartProvider.updateQuantity(productModel, CartItemSource.store, quantity - 1, sourceId: storeModel.id);
//                                       } else {
//                                         cartProvider.removeItem(productModel, CartItemSource.store, sourceId: storeModel.id);
//                                       }
//                                     },
//                                     borderRadius: BorderRadius.circular(16),
//                                     child: SizedBox(
...
//       floatingActionButton: GlobalCartFAB(
//         backgroundColor: theme.colorScheme.primary,
//         heroTag: 'category_products_fab',
//       ),
