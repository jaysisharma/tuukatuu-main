  ...
  return (
    <div className="flex min-h-screen bg-bg">
      ...
      <aside className="w-64 bg-surface border-r border-border flex flex-col shadow-md">
        ...
        <li><NavLink to="/admin/tmart-banners" className={({isActive}) => isActive ? 'block px-6 py-2 bg-primary text-white rounded' : 'block px-6 py-2 text-gray-700 hover:bg-gray-100 rounded'}>T-Mart Banners</NavLink></li>
